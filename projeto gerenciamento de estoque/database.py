...
def inicializar_banco():
    ...
    ''')
    # Adiciona colunas caso venham de versão anterior
    try:
...
def remover_produto(id_produto):
    try:
        with sqlite3.connect(DATABASE_NAME) as conn:
            ...
            conn.commit()
            return cursor.rowcount > 0 # Retorna True se algum produto foi removido
    except sqlite3.Error as e:
    ...
    try:
        with sqlite3.connect(DATABASE_NAME) as conn:
            ...
            if resultado:
                ...
                # Usa os valores antigos se os novos forem vazios
    ...
    try:
        with sqlite3.connect(DATABASE_NAME) as conn:
            ...
            if nova_quantidade < 0:
                return False  # Não pode deixar a quantidade negativa
